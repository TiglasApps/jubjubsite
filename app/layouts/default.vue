<template>
  <div class="min-h-screen bg-[#062b1f] text-white relative">
    <!-- Navbar -->
    <header
  :class="[
...
>
  ...
  <transition name="fade">
    <div
      v-if="mobileOpen"
      class="md:hidden bg-white text-black shadow-xl px-6 py-4 space-y-4 text-lg font-medium flex flex-col"
    >
